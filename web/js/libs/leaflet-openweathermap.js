 ...
 * License: CC0 (Creative Commons Zero), see https://tracktrack.io/api/tileproxy?url=http://creativecommons.org/publicdomain/zero/1.0/
 * Project page: https://github.com/buche/leaflet-openweathermap/
 */

L.OWM = L.TileLayer.extend({
	baseUrl: "https://tracktrack.io/api/tileproxy?url=http://{s}.tile.openweathermap.org/map/{layername}/{z}/{x}/{y}.png",
	options: {
		maxZoom: 18,
		showLegend: true,
...
(function () {
	...
	L.OWM.precipitationClassic = function (options) {
		...
		if (layer.options.legendImagePath == null) {
			layer.options.legendImagePath = 'https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/img/a/PR.png';
		}
		return layer;
	};
	...
	L.OWM.rainClassic = function (options) {
		...
		if (layer.options.legendImagePath == null) {
			layer.options.legendImagePath = 'https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/img/a/RN.png';
		}
		return layer;
	};
	...
	L.OWM.snow = function (options) { 
		...
		if (layer.options.legendImagePath == null) {
			layer.options.legendImagePath = 'https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/img/a/SN.png';
		}
		return layer; 
	};
	...
	L.OWM.cloudsClassic = function (options) {
		...
		if (layer.options.legendImagePath == null) {
			layer.options.legendImagePath = 'https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/img/a/NT.png';
		}
		return layer;
	};
	...
	L.OWM.pressure = function (options) {
		...
		if (layer.options.legendImagePath == null) {
			layer.options.legendImagePath = 'https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/img/a/PN.png';
		}
		return layer;
	};
	...
	L.OWM.temperature = function (options) { 
		...
		if (layer.options.legendImagePath == null) {
			layer.options.legendImagePath = 'https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/img/a/TT.png';
		}
		return layer;
	};
	...
	L.OWM.wind = function (options) { 
		...
		if (layer.options.legendImagePath == null) {
			layer.options.legendImagePath = 'https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/img/a/UV.png';
		}
		return layer;
	};
...
L.OWM.Current = L.Class.extend({
	...
	options: {
		...
		clusterSize: 150,
		imageUrlCity: 'https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/img/w/{icon}.png',
		imageWidth: 50,
		imageHeight: 50,
		imageUrlStation: 'https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/img/s/istation.png',
		imageWidthStation: 25,
		imageHeightStation: 25,
		imageUrlPlane: 'https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/img/s/iplane.png',
		imageWidthPlane: 25,
		imageHeightPlane: 25,
	...
	initialize: function(options) {
		...
		this._map = null;
		this._urlTemplate = 'https://tracktrack.io/api/tileproxy?url=http://api.openweathermap.org/data/2.5/box/{type}?{appId}cnt=300&format=json&units=metric&bbox={minlon},{minlat},{maxlon},{maxlat},10';
	...
	_createPopup: function(station) {
		...
		if (showLink) {
			...
			txt += '<a href="https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/' + typ + '/' + station.id + '" target="_blank" title="'
...
L.OWM.Utils = {
	...
	i18n: {
		...
		// weather conditions, see https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/wiki/API/Weather_Condition_Codes
		...
		// Wetterbedingungen, siehe https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/wiki/API/Weather_Condition_Codes
		...
		// Les conditions météorologiques, voir https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/wiki/API/Weather_Condition_Codes
		...
		// weeercondities, see https://tracktrack.io/api/tileproxy?url=http://openweathermap.org/wiki/API/Weather_Condition_Codes

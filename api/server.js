...
app.get("/", function(req, res) {
	serveHtml(res, "web/login.html", function(html) {
		return res.send(html);
	});
});
app.get("/trips", function(req, res) {
	serveHtml(res, "web/trips.html", function(html) {
		return res.send(html);
	});
});
app.get("/dashboard", function(req, res) {
	serveHtml(res, "web/dashboard.html", function(html) {
		return res.send(html);
	});
});
app.get("/time", function(req, res) {
	serveHtml(res, "time/index.html", function(html) {
		return res.send(html);
	});
});
...
// GET /BOATS
app.get("/api/boats/:owner", passport.authenticate("basic", {
	session: false
}), function(req, res) {
...
// GET /trips
app.get("/api/trips/:boat", passport.authenticate("basic", {
	session: false
}), function(req, res) {
...
// GET /trips/delete/
app.get("/api/trips/delete/:id", passport.authenticate("basic", {
	session: false
}), function(req, res) {
